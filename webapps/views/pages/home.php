        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="da-img">
                        <img src="webresources/img/parallax-slider/images/2.png" alt="image01" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="da-img">
                        <img src="webresources/img/parallax-slider/images/3.png" alt="image01" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="da-img">
                        <img src="webresources/img/parallax-slider/images/1.png" alt="image01" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="feature-box">
                <div class="col-md-4 col-sm-4 text-center wow fadeInUp">
                    <div class="feature-box-heading">
                        <em>
                            <img src="webresources/img/1.png" alt="" width="100" height="100">
                ...
                <div class="col-md-4 col-sm-4 text-center wow fadeInUp">
                    <div class="feature-box-heading">
                        <em>
                            <img src="webresources/img/2.png" alt="" width="100" height="100">
                        </em>
                        <h4>
                            <b>Well Documented</b>
                        </h4>
                ...
                <div class="col-md-4 col-sm-4 text-center wow fadeInUp">
                    <div class="feature-box-heading">
                        <em>
                            <img src="webresources/img/3.png" alt="" width="100" height="100">
                        </em>
                        <h4>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-sm-6 text-center wow fadeInLeft">
                <img src="webresources/img/tab1.png" alt="">
            </div>
                        ...
                        <div id="news" class="tab-pane fade in active">
                            <article class="media">
                                <a class="pull-left thumb p-thumb">
                                    <img src="webresources/img/product1.jpg" alt="">
                                </a>
                            ...
                            <article class="media">
                                <a class="pull-left thumb p-thumb">
                                    <img src="webresources/img/product2.jpg" alt="">
                                </a>
                                <div class="media-body b-btm">
                                    <a href="#" class=" p-head">
                ...
                <section class="slider wow fadeInRight">
                        ...
                        <ul class="slides about-flex-slides">
                            <li>
                                <div class="about-testimonial-image ">
                                    <img alt="" src="webresources/img/person_1.png">
                                </div>
                    ...
                    <span class="about-testimonial-company">
                      CCD Realestate
                            ...
                            <li>
                                <div class="about-testimonial-image ">
                                    <img alt="" src="webresources/img/person_2.png">
                                </div>
                                <a class="about-testimonial-author" href="#">
                                    Steven gerrard
                                </a>
            ...
            <div class="col-lg-12 recent">
                ...
                <div id="owl-demo" class="owl-carousel owl-theme wow fadeIn">
                    ...
                    <div class="item view view-tenth">
                        <img src="webresources/img/works/img8.jpg" alt="work Image">
                        <div class="mask">
                    ...
                    <div class="item view view-tenth">
                        <img src="webresources/img/works/img9.jpg" alt="work Image">
                        <div class="mask">
                            <a href="blog-detail.html" class="info" data-toggle="tooltip" data-placement="top" title="Details">
                                <i class="fa fa-link">
                                </i>
                    ...
                    <div class="item view view-tenth">
                        <img src="webresources/img/works/img10.jpg" alt="work Image">
                        <div class="mask">
                            <a href="blog-detail.html" class="info" data-toggle="tooltip" data-placement="top" title="Details">
                                <i class="fa fa-link">
                                </i>
                    ...
                    <div class="item view view-tenth">
                        <img src="webresources/img/works/img11.jpg" alt="work Image">
                        <div class="mask">
                            <a href="blog-detail.html" class="info" data-toggle="tooltip" data-placement="top" title="Details">
                                <i class="fa fa-link">
                                </i>
                    ...
                    <div class="item view view-tenth">
                        <img src="webresources/img/works/img12.jpg" alt="work Image">
                        <div class="mask">
                            <a href="blog-detail.html" class="info" data-toggle="tooltip" data-placement="top" title="Details">
                                <i class="fa fa-link">
                                </i>
                    ...
                    <div class="item view view-tenth">
                        <img src="webresources/img/works/img13.jpg" alt="work Image">
                        <div class="mask">
                            <a href="blog-detail.html" class="info" data-toggle="tooltip" data-placement="top" title="Details">
                                <i class="fa fa-link">
                                </i>
    ...
    <div class="row mar-b-50 our-clients">
        ...
        <div class="col-md-9">
            ...
            <ul class="bxslider1 clients-list">
                <li>
                    <a href="#">
                        <img src="webresources/img/clients/graylogo6.png" alt="" />

                        <img src="webresources/img/clients/newlogo6.png" class="color-img" alt="" />
                    </a>
                </li>
                <li>
                    <a href="#">
