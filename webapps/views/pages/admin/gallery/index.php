                    ...
                    <div class="box box-primary">
                        ...
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs">
                                ...
                                <li><a href="#tab_2" data-toggle="tab">FACTORIES</a></li>
                            </ul>
                                ...
                                <div class="tab-pane" id="tab_2">
                                    <div class="box-body table-responsive">
                                        <table id="example2" class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                            <?php foreach ($factories as $image): ?>
                                                <tr>
                                                    <td><img src="<?php echo $image['url_image']; ?>" class="img-responsive img-thumbnail" style="width: 200px;height: 200px;"/></td>
                                                    <td><?php echo $image['en_name'] ?></td>
                                                    <td>
                                            ...
                                            <tfoot><?php echo anchor('create-gallery/factories', '<i class="fa fa-plus"></i>Add new', 'class="btn btn-default pull-right"') ?></tfoot>
                                        </table>
                                    </div>
                                </div><!-- /.tab-pane -->
                            </div><!-- /.tab-content -->
