                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="news_en_content_editor" name="en_content" class="form-control"><?php echo htmlspecialchars_decode(strip_tags($news['en_content'])); ?></textarea>
                            </div>
                            <div class="form-group">
                                <label for="vi_content">Vietnamese content</label>
                                <textarea id="news_vi_content_editor" name="vi_content" class="form-control"><?php echo htmlspecialchars_decode(strip_tags($news['vi_content'])); ?></textarea>
                            </div>
                        </div>
