            ...
            <div class="col-sm-12 col-lg-12 col-md-12">
                <div class="docs-galley">
                    <ul class="docs-pictures clearfix">
                        <li><img data-original="<?php echo base_url(); ?>webresources/images/products/1.jpg"
