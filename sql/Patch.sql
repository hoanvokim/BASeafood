...
CREATE TRIGGER `news_INSERT` BEFORE INSERT ON `news`
FOR EACH ROW BEGIN
...
CREATE TRIGGER `news_UPDATE` BEFORE UPDATE ON `news`
FOR EACH ROW BEGIN
    -- Set the udpate date
    SET new.updated_date = now();
END;
...
INSERT INTO `baseafood`.`news` (`en_title`, `vi_title`, `en_content`, `vi_content`, `url_attached_file`)
VALUES ('Website encourages scrolling', 'Website tin tức', 'Quisque sed metus at justo vestibulum congue at et arcu. Maecen pellentesque lobortis ante. Vestibulum quam cursus eget augue purus', 'VN __ Quisque sed metus at justo vestibulum congue at et arcu. Maecen pellentesque lobortis ante. Vestibulum quam cursus eget augue purus', 'news/download/1.pdf');

INSERT INTO `baseafood`.`news` (`en_title`, `vi_title`, `en_content`, `vi_content`, `url_attached_file`)
VALUES ('Website encourages scrolling', 'Website tin tức', 'Quisque sed metus at justo vestibulum congue at et arcu. Maecen pellentesque lobortis ante. Vestibulum quam cursus eget augue purus', 'VN __ Quisque sed metus at justo vestibulum congue at et arcu. Maecen pellentesque lobortis ante. Vestibulum quam cursus eget augue purus', 'news/download/2.pdf');

INSERT INTO `baseafood`.`news` (`en_title`, `vi_title`, `en_content`, `vi_content`, `url_attached_file`)
VALUES ('Website encourages scrolling', 'Website tin tức', 'Quisque sed metus at justo vestibulum congue at et arcu. Maecen pellentesque lobortis ante. Vestibulum quam cursus eget augue purus', 'VN __ Quisque sed metus at justo vestibulum congue at et arcu. Maecen pellentesque lobortis ante. Vestibulum quam cursus eget augue purus', 'news/download/3.pdf');

INSERT INTO `baseafood`.`news` (`en_title`, `vi_title`, `en_content`, `vi_content`, `url_attached_file`)
VALUES ('Website encourages scrolling', 'Website tin tức', 'Quisque sed metus at justo vestibulum congue at et arcu. Maecen pellentesque lobortis ante. Vestibulum quam cursus eget augue purus', 'VN __ Quisque sed metus at justo vestibulum congue at et arcu. Maecen pellentesque lobortis ante. Vestibulum quam cursus eget augue purus', 'news/download/4.pdf');

INSERT INTO `baseafood`.`news` (`en_title`, `vi_title`, `en_content`, `vi_content`)
VALUES ('Website encourages scrolling', 'Website tin tức', 'Quisque sed metus at justo vestibulum congue at et arcu. Maecen pellentesque lobortis ante. Vestibulum quam cursus eget augue purus', 'VN __ Quisque sed metus at justo vestibulum congue at et arcu. Maecen pellentesque lobortis ante. Vestibulum quam cursus eget augue purus');
