...
(function (global, factory) {
    ...
    Viewer.prototype = {
        ...
        initList: function () {
            ...
            $('#page-breadcrumb').css('filter', ('blur(8px)'));
            $('.docs-pictures').css('filter', ('blur(8px)'));
            ...
            $('.docs-pictures').css('-webkit-filter', ('blur(8px)'));
        ...
        hide: function () {
            ...
            $('#page-breadcrumb').removeAttr('style');
            $('.docs-pictures').removeAttr('style');
        ...
        view: function (index) {
            ...
            addListener(element, EVENT_VIEWED, function () {
                ...
                //var altHtml = $.parseHTML(alt);
                appendHTML(title, alt);
            }, true);
        ...
        play: function () {
            ...
            each(_this.items, function (item, i) {
                ...
                image.description = img.getAttribute('description');
                total++;
